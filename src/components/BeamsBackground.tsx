...
function DirLight({ position, color, intensity = 1 }: { position: [number, number, number]; color: string; intensity?: number }) {
  ...
  vec3 getNormal(vec3 pos) {
    ...
    gl_FragColor.rgb -= randomNoise / 15. * uNoiseIntensity;`,
        ...
        uniforms: {
          ...
          time: { shared: true, mixed: true, linked: true, value: 0 } as unknown as THREE.IUniform<number>,
          roughness: 0.3,
          metalness: 0.3,
          uSpeed: { shared: true, mixed: true, linked: true, value: speed } as unknown as THREE.IUniform<number>,
          envMapIntensity: 10,
    ...
    <>
      <group rotation={[0, 0, degToRad(rotation)]}>
        <PlaneNoise
          ...
          height={beamHeight}
        />
        <DirLight color={lightColor} intensity={0.12} position={[0, 3, 10]} />
      </group>
